...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_futhark_new_u32_2d')) {
        Object.defineProperty(Module['ready'], '_futhark_new_u32_2d', { configurable: true, get: function() { abort('You are getting _futhark_new_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_futhark_new_u32_2d', { configurable: true, set: function() { abort('You are setting _futhark_new_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_futhark_free_u32_2d')) {
        Object.defineProperty(Module['ready'], '_futhark_free_u32_2d', { configurable: true, get: function() { abort('You are getting _futhark_free_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_futhark_free_u32_2d', { configurable: true, set: function() { abort('You are setting _futhark_free_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_futhark_shape_u32_2d')) {
        Object.defineProperty(Module['ready'], '_futhark_shape_u32_2d', { configurable: true, get: function() { abort('You are getting _futhark_shape_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_futhark_shape_u32_2d', { configurable: true, set: function() { abort('You are setting _futhark_shape_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_futhark_values_raw_u32_2d')) {
        Object.defineProperty(Module['ready'], '_futhark_values_raw_u32_2d', { configurable: true, get: function() { abort('You are getting _futhark_values_raw_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_futhark_values_raw_u32_2d', { configurable: true, set: function() { abort('You are setting _futhark_values_raw_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_futhark_values_u32_2d')) {
        Object.defineProperty(Module['ready'], '_futhark_values_u32_2d', { configurable: true, get: function() { abort('You are getting _futhark_values_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_futhark_values_u32_2d', { configurable: true, set: function() { abort('You are setting _futhark_values_u32_2d on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'raytracer.wasm';
...
var ASM_CONSTS = {
  6520: function() {throw 'Canceled!'},  
 6771: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);}
};
function initPthreadsJS(){ PThread.initRuntime(); }
  ...
  var PThread={unusedWorkers:[],runningWorkers:[],initMainThreadBlock:function() {
        ...
        var pthreadMainJs = locateFile('raytracer.worker.js');
...
/** @type {function(...*):?} */
var _futhark_new_u32_2d = Module["_futhark_new_u32_2d"] = createExportWrapper("futhark_new_u32_2d");

/** @type {function(...*):?} */
var _futhark_free_u32_2d = Module["_futhark_free_u32_2d"] = createExportWrapper("futhark_free_u32_2d");

/** @type {function(...*):?} */
var _futhark_values_u32_2d = Module["_futhark_values_u32_2d"] = createExportWrapper("futhark_values_u32_2d");

/** @type {function(...*):?} */
var _futhark_values_raw_u32_2d = Module["_futhark_values_raw_u32_2d"] = createExportWrapper("futhark_values_raw_u32_2d");

/** @type {function(...*):?} */
var _futhark_shape_u32_2d = Module["_futhark_shape_u32_2d"] = createExportWrapper("futhark_shape_u32_2d");
...
var __emscripten_main_thread_futex = Module['__emscripten_main_thread_futex'] = 7580;
...
new_u32_2d_from_jsarray(array2d) {
  return this.new_u32_2d(array2d.flat(), array2d.length, array2d[0].length);
}
new_u32_2d(array, d0, d1) {
  console.assert(array.length === d0*d1, 'len=%s,dims=%s', array.length, [d0, d1].toString());
  var copy = _malloc(array.length << 2);
  HEAPU32.set(array, copy >> 2);
  var ptr = _futhark_new_u32_2d(this.ctx, copy, BigInt(d0), BigInt(d1));
  _free(copy);
  return this.new_u32_2d_from_ptr(ptr);
}
new_u32_2d_from_ptr(ptr) {
  return new FutharkArray(this.ctx, ptr, 'u32', 2, HEAPU32, _futhark_shape_u32_2d, _futhark_values_raw_u32_2d, _futhark_free_u32_2d);
}
...
main(in0, in1, in2, in3) {
  ...
  if (_futhark_entry_main(this.ctx, ...out, in0, in1, in2, in3) > 0) {
    do_free();
    throw this.get_error();
  }
  var result0 = this.new_u32_2d_from_ptr(HEAP32[out[0] >> 2]);
